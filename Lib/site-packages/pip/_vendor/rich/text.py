...
class Text(JupyterMixin):
    ...
    def on(self, meta: Optional[Dict[str, Any]] = None, **handlers: Any) -> "Text":
        ...
        Example:
            ...
            >>> tex.on(click="view.toggle('world')")
...
if __name__ == "__main__":  # pragma: no cover
    ...
    tex.highlight_words(["Lorem"], "bold")
    tex.highlight_words(["ipsum"], "italic")

    console = Console()

    console.rule("justify='left'")
    console.print(tex, style="red")
    console.print()

    console.rule("justify='center'")
    console.print(tex, style="green", justify="center")
    console.print()

    console.rule("justify='right'")
    console.print(tex, style="blue", justify="right")
    console.print()

    console.rule("justify='full'")
    console.print(tex, style="magenta", justify="full")
    console.print()
